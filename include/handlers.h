...
//Added as per RFC 3588 
const int32_t DIAMETER_COMMAND_UNSUPPORTED = 3001;
const int32_t DIAMETER_REALM_NOT_SERVED = 3003;
const int32_t DIAMETER_TOO_BUSY = 3004;
const int32_t DIAMETER_LOOP_DETECTED = 3005;
const int32_t DIAMETER_REDIRECT_INDICATION = 3006;
const int32_t DIAMETER_APPLICATION_UNSUPPORTED = 3007;
const int32_t DIAMETER_INVALID_HDR_BITS =  3008;
const int32_t DIAMETER_INVALID_AVP_BITS  =  3009;
const int32_t DIAMETER_UNKNOWN_PEER = 3010;
//Added as per RFC 3588 Transient Failures
const int32_t DIAMETER_AUTHENTICATION_REJECTED =  4001;
const int32_t DIAMETER_OUT_OF_SPACE = 4002; 
const int32_t ELECTION_LOST = 4003;

//Added as per RFC 3588 Permanent Failures
const int32_t DIAMETER_AVP_UNSUPPORTED = 5001;
const int32_t DIAMETER_UNKNOWN_SESSION_ID = 5002;
const int32_t DIAMETER_AUTHORIZATION_REJECTED = 5003;
const int32_t DIAMETER_INVALID_AVP_VALUE = 5004;
const int32_t DIAMETER_MISSING_AVP = 5005;
const int32_t DIAMETER_RESOURCES_EXCEEDED =       5006;
const int32_t DIAMETER_CONTRADICTING_AVPS =       5007;
const int32_t DIAMETER_AVP_NOT_ALLOWED  =         5008;
const int32_t DIAMETER_AVP_OCCURS_TOO_MANY_TIMES = 5009;
const int32_t DIAMETER_NO_COMMON_APPLICATION  =   5010;
const int32_t DIAMETER_UNSUPPORTED_VERSION    =   5011;
const int32_t DIAMETER_UNABLE_TO_COMPLY  =        5012;
const int32_t DIAMETER_INVALID_BIT_IN_HEADER =     5013;
const int32_t DIAMETER_INVALID_AVP_LENGTH     =   5014;
const int32_t DIAMETER_INVALID_MESSAGE_LENGTH  =  5015;
const int32_t DIAMETER_INVALID_AVP_BIT_COMBO    = 5016;
const int32_t DIAMETER_NO_COMMON_SECURITY     =   5017;
